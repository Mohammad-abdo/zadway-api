...
import * as ctrl from "./product-order-location-updates.controller.js";
import authenticate from "../../core/middlewares/auth.middleware.js";
import { requirePermission, requireResourceAccess } from "../../core/middlewares/authorize.middleware.js";
import { validate } from "../../core/middlewares/validate.middleware.js";
import * as v from "./product-order-location-updates.validator.js";

const r = Router();
const PERM = "product_order_location_updates.manage";
